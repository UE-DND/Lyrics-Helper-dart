...
class LrcGenerator {
  ...
  static void _appendLine(StringBuffer sb, ILineInfo line) {
    ...
    sb.writeln(
        '[${_formatTimeMsToTimestampString(line.startTime!)}]${line.text}');
  }
  ...
  static void _appendLineWithSub(StringBuffer sb, ILineInfo line) {
    ...
    sb.writeln(
        '[${_formatTimeMsToTimestampString(line.startTimeWithSubLine!)}]${line.fullText}');
  }
  ...
  // 判断是否应该添加行结束时间
  static bool _shouldAddLine(List<ILineInfo> lines, ILineInfo line,
      bool withSub, int index, EndTimeOutputType endTimeOutputType) {
